...
void camReset( raaCamera &rCam )
{
	...
	vecSet(-1700.0f, 1010.0f, 225.0f, rCam.m_fVP);
	vecSet(0.95f, -0.31f, 0.08f, rCam.m_fVD);
	vecSet(-0.05f, -0.00f, 1.00f, rCam.m_fVR);
	vecSet(0.30f, 0.95f, -0.01f, rCam.m_fVU);
	vecSet(266.0f, 400.0f, 325.0f, rCam.m_fVT);
	rCam.m_fNear=0.2f;
